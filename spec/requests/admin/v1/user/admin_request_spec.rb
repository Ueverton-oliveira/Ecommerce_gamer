  ...
  context "GET /users" do
    ...
    context "without any params" do
      ...
      it "returns 10 first Users" do
        get url, headers: auth_header(login_user)
        expected_users = users[0..9].as_json(only: %i(id name email profile))
    ...
    context "with pagination params" do
      ...
      it "returns categories limited by pagination" do
        get url, headers: auth_header(login_user), params: pagination_params
        expected_users = users[5..9].as_json(only: %i(id name email profile))
        expect(body_json['users']).to contain_exactly *expected_users
      end
  ...
  context "POST /users" do
    ...
    context "with valid params" do
      ...
      it 'returns last added User' do
        post url, headers: auth_header(login_user), params: user_params
        expected_category = User.last.as_json(only: %i(id name email profile))
        expect(body_json['user']).to eq expected_users
      end
